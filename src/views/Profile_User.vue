  ...
  <UserLayout class="body bg-[#E1F5FE] min-h-screen">
    <div class="pt-32 bg-[#E1F5FE] mb-10">
      ...
      <div class="flex mx-44 mb-4 h-[32vw]">
        ...
        <div class="flex w-[25%] ">
          <div class="row  mb-5">
            ...
            <div class="flex mb-5">
              ...
              <div>
                <div class="link link-hover font-bold text-[#4285F4]">อนุรักษา คำมุงคุล</div>
                <div class="link link-hover font-normal text-base text-[#7F7F7F]">แก้ไขข้อมูลส่วนตัว</div>
              </div>
              <!-- Hidden file input -->
        ...
        <div class="flex w-[75%]">
          <!-- New white background box on the right -->
      ...
      <div class="flex mx-44 justify-end">
...
export default {
  ...
  data() {
    return {
      imageSrc: null // Shared between both components
    };
  },
  methods: {
    triggerFileInput() {
    ...
    onImageChange(event) {
      ...
      if (file) {
        this.imageSrc = URL.createObjectURL(file); // Update imageSrc for both sections
      }
    }
  }
};
